...
public class OutputFileTV2 {
	public JDBCConnection jdbc;
	public OutputFileTV2(JDBCConnection jdbc){
		this.jdbc = jdbc;
	}
	...
	public void tencentOutput(String s, long time)  {
		...
		// 对应的每一集
			...
			title = s.substring(burl + 2, nameEnd) + "   <type>t</type>";
