...
public class URLMakertv {
	public static ArrayList<String> connect(ArrayList<String> baseUrl) throws IOException, InterruptedException{
		String url = "http://v.qq.com/list/2_-1_-1_-1_0_0_0_20_-1_-1_0.html";
		String aurl="http://v.qq.com/list/2_-1_-1_-1_0_0_";
		String burl="_20_-1_-1_0.html";
